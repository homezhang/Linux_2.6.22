...
//By HONG;	s3c2410_gpio_cfgpin(S3C2410_GPB0, S3C2410_GPB0_OUTP); // back light control

//By HONG;	s3c2410_gpio_pullup(S3C2410_GPB0, 0); 

//By HONG;	s3c2410_gpio_setpin(S3C2410_GPB0, 1);	// back light control, enable
#endif
...
static int __init s3c2410fb_probe(struct platform_device *pdev)
{
	...
	// add by thisway.diy@163.com, for eBlocks
//By HONG;	s3c2410_gpio_setpin(S3C2410_GPB0, 0);	// back light control
